const BASE_URL = "http://myadvaisor.com:4001/user"
...
export const getRecommendation   = (survey_id)   => apiCall("/survey/recommendation", "POST", { survey_id })
...
// Answers
export const saveAnswer          = (session_id, survey_id, question_id, option_id, question_type) =>
  apiCall("/survey/answer/save", "POST", { session_id, survey_id, question_id, option_id, question_type })
